...
## EPIC 0 â€” Repository foundation
...
- [x] E0.13 Verify Ruff and `ty` gates. Both are green in CI as of PR #1.
  ...
  these two gates â€” see `QUALITY_GATES.md`.
...
## EPIC 4 â€” Execution compiler/runtime
...
## EPIC 8 â€” Documentation and introspection
...
## EPIC 0A â€” Project/app scaffolding
...
## EPIC 0B â€” Agentic repository governance
...
- [x] E0B.7 Validate Issue â†’ branch â†’ PR â†’ merge â†’ close flow.
