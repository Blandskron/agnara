...
| Streaming request bodies, large uploads | Needs the streaming model, I2, `0.1.0a6`. Until then an upload is bounded `bytes`. |
| Streaming responses, server-sent events, **WebSocket**s | I2, `0.1.0a6`. The ASGI boundary handles no `websocket` scope. |
