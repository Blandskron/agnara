...
| Stable public API | V1-31–V1-33 | Per-export stable/removal decision, compatibility policy and migration guidance. | The V1-31 PR requires formal maintainer review before release closure. |
...
The seven reviewed distributions remain the publication set. Their 166 stable
exports have 166 distinct names at 166 canonical import paths.
`docs/releases/1.0-api-classification.md` records the decision to remove 171
duplicate alias paths from the declared public surface before 1.0.
