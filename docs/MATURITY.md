...
| Capability-to-capability composition | `DESIGNED` | ADR 0093 fixes same-compiled-application child-context isolation, independent policy/confirmation, deadline/cancellation derivation, idempotency isolation and recursion strategy. No nested invocation runtime, public API, stream composition or cross-app invocation exists. |
