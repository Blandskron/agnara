...
def _test_app_boundaries(name: str) -> str:
    return f'''"""Architecture rules for dependencies between bounded-context apps."""
...
def project_files(name: str) -> dict[str, str]:
    ...
    files = {
        ...
        "tests/test_architecture.py": _test_app_boundaries(name),
